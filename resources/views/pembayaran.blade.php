            ...
            <div class="row w-100 m-0">
                <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                    <div class="card col-lg-8 mx-auto">
                        <div class="text-left text-md-mid mb-3 mb-md-0 mt-3">
                            <a href="{{ route('tiket') }}">
                                <button type="submit" class="btn btn-outline-danger">
                                    <div class="text-center text-md-mid mb-3 mb-md-0">
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="card card-outline-info">
                                                        ...
                                                        <p class="text-muted py-lg-2">Dengan memahami syarat dan ketentuan,
                                                            Anda
                                                                ...
                                                                <div class="card-body">
                                                                    <ol class="p-1 text-muted">
                                                                        <li>Penggunaan Layanan
                                                                            <ul>
                                                                                <li>Layanan pembayaran menggunakan Link Aja
                                                                                    dan
                                                                                    Dana
                                                                                    hanya dapat digunakan untuk pembayaran
                                                                                    atas
                                                                                    transaksi yang sah dan sah di Indonesia.
                                                                                </li>
                                                                                <li>Setiap transaksi harus dilakukan oleh
                                                                                    pemilik akun
                                                                                    terdaftar dan harus dilakukan secara sah
                                                                                    dan
                                                                                    legal.
                                                                                </li>
                                                                                <li>Pengguna bertanggung jawab penuh atas
                                                                                    segala
                                                                                    tindakan yang dilakukan dengan akun
                                                                                    mereka
                                                                                    dan
                                                                        ...
                                                                        <li>Metode Pembayaran
                                                                            <ul>
                                                                                <li>Pembayaran dapat dilakukan menggunakan
                                                                                    saldo
                                                                                    Link
                                                                                    Aja atau Dana yang cukup atau
                                                                                    menggunakan
                                                                                    metode
                                                                                    pembayaran yang telah ditetapkan oleh
                                                                                    Layanan.</li>
                                                                                <li>Pembayaran harus dilakukan dalam waktu
                                                                                    yang
                                                                        ...
                                                                        <li>Biaya dan Tarif
                                                                            <ul>
                                                                                <li>Biaya dan tarif untuk penggunaan Layanan
                                                                                    ...
                                                                                    berbeda-beda
                                                                                    tergantung pada jenis transaksi dan
                                                                                    metode
                                                                                    pembayaran yang digunakan.</li>
                                                                                <li>Pengguna harus membayar biaya dan tarif
                                                                                    yang
                                                                        ...
                                                                        <li>Kebijakan Pengembalian Dana
                                                                            <ul>
                                                                                <li>Pengembalian dana dapat dilakukan jika
                                                                                    ...
                                                                                    transaksi atau
                                                                                    jika dana tidak digunakan dalam waktu
                                                                                    yang
                                                                                    ditentukan oleh Layanan.</li>
                                                                                <li>Pengembalian dana dapat dikenakan biaya
                                                                                    tambahan
                                                                                    atau dikenakan syarat dan ketentuan
                                                                                    tertentu
                                                                                    yang
                                                                        ...
                                                                        <li>Privasi dan Keamanan
                                                                            <ul>
                                                                                <li>Layanan pembayaran menggunakan Link Aja
                                                                                    ...
                                                                                    pribadi
                                                                                    pengguna.</li>
                                                                                <li>Layanan akan melakukan tindakan
                                                                                    pencegahan
                                                                                    yang
                                                                                    wajar untuk melindungi informasi pribadi
                                                                                    pengguna,
                                                                                    namun Layanan tidak bertanggung jawab
                                                                                    atas
                                                                                    kehilangan atau penggunaan informasi
                                                                                    pribadi
                                                                                    pengguna yang disebabkan oleh tindakan
                                                                                    yang
                                                                                    tidak
                                                                                    sah atau penyalahgunaan oleh pihak
                                                                                    ketiga.
                                                                                </li>
                                                                            </ul>
                                                                        </li><br>
                                                                        <li>Perubahan Syarat dan Ketentuan
                                                                            <ul>
                                                                                <li>Layanan berhak untuk mengubah syarat dan
                                                                                    ...
                                                                                    pemberitahuan
                                                                                    terlebih dahulu.</li>
                                                                                <li>Pengguna diharapkan untuk membaca syarat
                                                                                    dan
                                                                        ...
                                                                        <li>Penyelesaian Sengketa
                                                                            <ul>
                                                                                <li>Jika terjadi sengketa terkait penggunaan
                                                                                    Layanan
                                                                                    pembayaran menggunakan Link Aja dan
                                                                                    Dana,
                                                                                    maka pihak
                                                                                    yang terlibat diharapkan untuk
                                                                                    menyelesaikan
                                                                                    sengketa tersebut secara damai.</li>
                                                                                <li>Jika penyelesaian damai tidak
                                                                                    memungkinkan,
                                                                                    maka
                                        ...
                                        <div class="text-center text-md-mid mb-3 mb-md-0">
                                            <button type="submit" class="btn btn-rounded btn-lg btn-success"
                                                id="pay-button">Bayar
                                                Sekarang</button>
                                        </div>
                                    </div>
