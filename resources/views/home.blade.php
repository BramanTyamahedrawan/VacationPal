                        ...
                        <div class="d-flex justify-content-lg-center mb-1">
                            <div class="col-lg-6">
                                ...
                                <h2 id="desc" class="display-12 mb-4 animated slideInDown" style="color:white;">
                                    Permata alam yang menakjubkan dengan air lautnya yang bening dan 3 warna air yang berpadu harmonis
                                </h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-lg-center mb-1">
                            <div class="col-lg-6">
                                <h1 id="titleslide" class="display-1 mb-4 animated slideInDown" style="color:white;">&nbsp;Pantai 3
                                    Warna</h1>
                                <h2 id="desc" class="display-12 mb-4 animated slideInDown" style="color:white;">
                                    Hamparan pasir putih yang menyejukkan, air laut yang memikat, dan vegetasi pantai yang hijau
                                </h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border rounded p-4">
                    <nav>
                        <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                            <button class="nav-link fw-semi-bold active" id="nav-story-tab" data-bs-toggle="tab" data-bs-target="#nav-story" type="button" role="tab" aria-controls="nav-story" aria-selected="true">Deskripsi</button>
                            <button class="nav-link fw-semi-bold" id="nav-mission-tab" data-bs-toggle="tab" data-bs-target="#nav-mission" type="button" role="tab" aria-controls="nav-mission" aria-selected="false">Lokasi</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                            <p class="mb-0">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5744.901536727792!2d112.67663673296389!3d-8.439488875114831!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd601147042ed43%3A0x3d8b26de55357956!2sPantai%20Tiga%20Warna!5e0!3m2!1sid!2sid!4v1683266958659!5m2!1sid!2sid" width="580" height="394" style="border:0; position:center;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                                </iframe>
                            </p>
                        </div>
